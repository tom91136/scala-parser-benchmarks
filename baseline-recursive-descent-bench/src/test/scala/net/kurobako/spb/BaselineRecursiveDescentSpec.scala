...
import net.kurobako.spb.BaselineRecursiveDescentBench.{BrainFuckBench, SimpleBench}
...
class BaselineRecursiveDescentSpec extends FlatSpec with Matchers with EitherValues {
