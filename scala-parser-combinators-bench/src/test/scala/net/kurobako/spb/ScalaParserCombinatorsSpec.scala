...
import net.kurobako.spb.ScalaParserCombinatorsBench.{BrainFuckBench, JsonBench, SimpleBench}
...
class ScalaParserCombinatorsSpec extends FlatSpec with Matchers with EitherValues {
